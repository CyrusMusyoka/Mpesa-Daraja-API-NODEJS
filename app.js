// node js server for DARAJA API MPESA PAYMENT INTEGRATION
...
async function getAccessToken() {
  const consumer_key = "veSNc6IzG2adgjXgDtW53NqdWb33L1gyrhuNX8nH0Fd9zd7G"; // REPLACE IT WITH YOUR CONSUMER KEY
  const consumer_secret = "UwDuu9lkT4mwHgTqC8aHEViliUkE1hXhc4hoS3AKddP8Ces1PDxA1cT4DJQR0wIy"; // REPLACE IT WITH YOUR CONSUMER SECRET
  const url =
...
app.get("/", (req, res) => {
  res.send("MPESA DARAJA API WITH NODE JS PAYMENT ");
      ...
      axios
        .post(
          url,
          {
            ...
            Amount: "100000",
            PartyA: "254743421206", //phone number to receive the stk push
            PartyB: "174379",
            PhoneNumber: "254743421206",
            CallBackURL: "https://dd3d-105-160-22-207.ngrok-free.app/callback",
            AccountReference: "CyrusM NewLife Xcom",
        ...
        .then((response) => {
          res.send("Payment Request is successful done ✔✔. Please enter mpesa pin to complete the transaction");
        })
        .catch((error) => {
          console.log(error);
      ...
      axios
        .post(
          url,
          {
            ...
            Amount: "1",
            PartyA: "600996",
            PartyB: "254743421206",//phone number to receive the stk push
            Remarks: "Withdrawal",
